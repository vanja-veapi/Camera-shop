        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LensMount = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cameras_SensorTypes_SensorTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Discounts_Cameras_CameraId",
                        column: x => x.CameraId,
                        principalTable: "Cameras",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stocks_Cameras_CameraId",
                        column: x => x.CameraId,
                        principalTable: "Cameras",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartItems", x => new { x.CartId, x.CameraId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItems", x => new { x.OrderId, x.CameraId });
                    table.ForeignKey(
                        name: "FK_OrderItems_Cameras_CameraId",
                        column: x => x.CameraId,
                        principalTable: "Cameras",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CameraImages_CameraId",
                table: "CameraImages",
                column: "CameraId");

            migrationBuilder.CreateIndex(
                name: "IX_Camera_BluetoothSupport",
                table: "Cameras",
                column: "BluetoothSupport");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Camera_LensMount",
                table: "Cameras",
                column: "LensMount");

            migrationBuilder.CreateIndex(
                name: "IX_Camera_WifiSupport",
                table: "Cameras",
                column: "WifiSupport");

            migrationBuilder.CreateIndex(
                name: "IX_Cameras_SensorTypeId",
                table: "Cameras",
                column: "SensorTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Discounts_CameraId",
                table: "Discounts",
                column: "CameraId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_CameraId",
                table: "OrderItems",
                column: "CameraId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SensorTypes_Type",
                table: "SensorTypes",
                column: "Type",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Stocks_CameraId",
                table: "Stocks",
                column: "CameraId",
                unique: true);
